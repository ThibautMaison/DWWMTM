...
<div class="d-flex align-items-start justify-content-evenly mt-5 mx-5">
    <div class="d-flex gap-4 flex-column w-25 mx-5" style="margin-left: 200px;">
        <div class="card border-primary border-3 mx-3" style="background-color: #c7c7c7;">
            ...
            <a class="btn btn-dark rounded col-10 mx-auto rounded text-white my-2 gap-2 fw-semibold fst-italic" href="<?= URL ?>Boutique">Tous les produits</a>
            ...
            <a href="<?= URL ?>Boutique/l/<?= $Boutique[$i]->getId() ?>" class="link-dark">
                <div class="d-grid ms-4 mb-4 ">
                    <div class="card mx-auto" style="background-color: #c7c7c7;">
                        <img src="/public/images/<?= $Boutique[$i]->getImage() ?>" class=" d-grid gap-2 mx-3 d-flex justify-content-center mt-4 services-list mb-3" style="height: 200px;width: 200px;">
                        <h5 class=" d-grid gap-2 mx-auto d-flex justify-content-center mb-3  <?= $Boutique[$i]->getId() ?>"><?= $Boutique[$i]->getName() ?></h5>
                        <?php
                        if (isset($_SESSION['Pseudo'])) {
                            if (($_SESSION['Role']) == 1) { ?>
