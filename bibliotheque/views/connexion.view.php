...
<form method="POST" action="<?= URL ?>connexion/3" enctype="multipart/form-data" class="d-grid gap-2 col-6 mx-auto mt-5">
    <!-- enctype="multipart/form-data" obliger de le mettre quand on charge un fichier -->
    <div class="form-group mb-2">
        <label class="text-white" for="Pseudo"></label>
    ...
    <button type="submit" name="Connecter" class="btn btn-outline-light rounded-pill mb-5 d-grid gap-2 col-6 mx-auto">Se connecter</button>
    </div>

    <!-- Register buttons -->
    <div class="text-center">
        <p class="text-white ">Not a member? <a href="inscription">Register</a></p>
