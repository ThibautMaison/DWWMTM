...
<div class="me-5 mx-auto">
    <h1 class="text-white text-uppercase fw-bold mb-5 fst-italic d-flex justify-content-center me-5 " style="font-size: 100px;">Boutique</h1>
    <h2 class="text-white my-5 fs-3 text-center me-5 mx-auto">Trouvez tous mes conseils pour vous équiper le mieux possible.
...
<div id="target" class="d-flex col-10 flex-wrap mx-auto">
<div class="d-flex gap-4 flex-column w-25 wrap me-3 mt-5">
    <div class="card border-primary border-3" style="background-color: #c7c7c7;">
        ...
        <a class="btn btn-dark rounded col-10 mx-auto rounded text-white my-2 gap-2 fw-semibold fst-italic" href="<?= URL ?>Boutique#target">Tous les produits</a>
        ...
        <a class="btn rounded text-dark col-10 mx-auto my-2 gap-2 fw-semibold fst-italic" href="<?= URL ?>Boutique/casque#target">Casques</a>
