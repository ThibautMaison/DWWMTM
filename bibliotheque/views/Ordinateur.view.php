...
<div class="d-flex align-items-start justify-content-evenly mt-5 mx-5" >
    <div class="d-flex gap-4 flex-column w-25 mx-5" style="margin-left: 200px;">
        <div class="card border-primary border-3 mx-3">
            ...
            <a class="btn btn-outline-light rounded text-dark border-white mt-4 mb-2 gap-2 fw-semibold fst-italic" href="<?= URL ?>Ordinateur">Ordinateur</a>
            ...
            <div class="d-grid ms-2 mb-2">
                <div class="card" style="height: 400px;width: 300px;">
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        <form action="<?= URL ?>Boutique/m/<?= $Boutique[$i]->getId() ?>" onSubmit="return confirm('Voulez-vous vraiment modifier le produit ?')" method="POST">
