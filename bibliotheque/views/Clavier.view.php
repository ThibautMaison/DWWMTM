...
<div class="me-5">
    <h1 class="text-white text-uppercase fw-bold mb-5 fst-italic d-flex justify-content-center" style="font-size: 100px;">Clavier</h1>
...
<div class="d-flex align-items-start justify-content-evenly  mx-5" >
    <div class="d-flex gap-4 flex-column w-25 mx-5" style="margin-left: 200px;">
        <div class="card border-primary border-3 mx-3" style="background-color: #c7c7c7;" >
            ...
            <a class="btn btn-dark rounded col-10 mx-auto rounded text-white my-2 gap-2 fw-semibold fst-italic" href="<?= URL ?>Boutique/clavier">Claviers</a>
